      ...
      <div className="border-y-2 border-black px-4">
        <div className="max-w-[1140px] mx-auto w-full border-x-2 border-black">
          <div className="py-[99px] relative flex flex-col pl-9 max-xl:pl-6 max-lg:gap-10 max-lg:pl-20 max-md:gap-6 max-md:pl-[60px] max-md:pr-4 max-lg:py-16 max-md:py-10">
            <div className="h-[86%] w-0.5 bg-black absolute left-1/2 -translate-x-1/2 roadmap-line top-[52%] -translate-y-1/2 max-lg:left-[5%] max-lg:h-[90%] max-md:left-[7%] max-md:h-[95%] max-md:top-[51%]"></div>
            {ROADMAP_LIST.map((obj, i) => (
              <div
                key={i}
                className={`relative ${
                  i === 0 || i === 2 || i === 4 || i === 6
                    ? "max-w-[599px] max-xl:max-w-[468px] ml-auto after:absolute after:content='' after:top-0 after:bg-[url('/assets/images/roadmap-icon.webp')] after:bg-cover after:bg-center after:bg-no-repeat after:w-[59px] after:h-[59px] after:left-[-21%] max-xl:after:left-[-12%] max-lg:after:left-[-14%] max-lg:mr-auto max-lg:ml-0 max-lg:after:w-11 max-lg:after:h-11 max-md:after:left-[-17%] max-[424px]:after:!left-[-21.5%] max-xl:pl-2 max-lg:pl-0"
                    : "max-w-[564px] max-xl:max-w-[428px] mr-auto roadmap-left-content -mt-4 after:absolute after:content='' after:top-0 after:bg-[url('/assets/images/roadmap-icon.webp')] after:bg-cover after:bg-center after:bg-no-repeat after:w-[59px] after:h-[59px] after:right-[-22.5%] max-xl:after:right-[-17%] max-lg:max-w-[468px] max-lg:mt-0 max-lg:after:left-[-14%] max-lg:after:w-11 max-lg:after:h-11 max-md:after:left-[-17%] max-[424px]:after:!left-[-21.5%]"
                } ${
                  i === 1
                    ? "-mt-20 max-lg:mt-0"
                    : i === 3
